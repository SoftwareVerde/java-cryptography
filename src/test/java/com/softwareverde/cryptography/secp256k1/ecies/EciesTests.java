...
public class EciesTests {
    ...
    public void should_encrypt_and_decrypt_data() {
        ...
        final ByteArray payload = MutableByteArray.wrap(StringUtil.stringToBytes(message));
    ...
    public void bitcore_test() {
        ...
        final ByteArray message = MutableByteArray.wrap(StringUtil.stringToBytes("attack at dawn"));
